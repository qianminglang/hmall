...
import com.hmall.common.config.utils.CollUtils;
...
//    private final IItemService itemService;
    ...
    private void handleCartItems(List<CartVO> vos) {
        ...
        // 2.查询商品
        List<ItemDTO> items = itemClient.queryItemByIds(CollectionUtil.newArrayList(itemIds));
//        List<ItemDTO> items= getInfoByRestemplet(itemIds);
    ...
    private List<ItemDTO> getInfoByRestemplet(Set<Long> itemIds) {
